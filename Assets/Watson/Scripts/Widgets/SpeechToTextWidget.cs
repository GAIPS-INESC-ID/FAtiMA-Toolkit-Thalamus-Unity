...
namespace IBM.Watson.DeveloperCloud.Widgets
{
  ...
  public class SpeechToTextWidget : Widget
  {
	...
	[SerializeField]
	private float m_KeywordsThreshold = 0.0f;
    #endregion
    ...
    public bool Active
    {
      ...
      set
      {
        if (value && !m_SpeechToText.IsListening)
        {
		  ...
		  //JD change, added Keywords and KeywordThreshold to support new Keyword functionality from Watson Speech2Text API
		  m_SpeechToText.Keywords = m_Keywords;
		  m_SpeechToText.KeywordsThreshold = m_KeywordsThreshold;
